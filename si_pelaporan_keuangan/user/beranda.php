...
<section class="content">
	...
	<div class="row">
	<?php
		$query="SELECT tb_transaksi.* FROM tb_kegiatan INNER JOIN tb_transaksi ON tb_kegiatan.id_kegiatan = tb_transaksi.id_kegiatan where tb_kegiatan.id_unit='$id' GROUP BY tb_transaksi.id_kegiatan";
		...
		<p><?= $data['keterangan']?>.</p>
		<hr>
		<p class="mb-0">BERIKUT NOMINAL YANG PERLU DI TRANSAKSIKAN <?= number_format($data['debet'], 0, ".", ".") ?>.</p>
		</div>
		</div>
